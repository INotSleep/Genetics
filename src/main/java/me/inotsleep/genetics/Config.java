...
public class Config extends AbstractConfig {
    ...
    public void doReloadConfig() {
        ...
        publicGenesSection.getKeys(false).forEach((gene) -> {
            ...
            new Gene(gene, dominantActions, recessiveActions, publicGenesSection.getDouble(gene+".chance"), publicGenesSection.getDouble(gene+".dominantChance"), publicGenesSection.getDouble(gene+".recessiveChance"), null);
        });
